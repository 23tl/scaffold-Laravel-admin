...
<div class="layui-form layuimini-form">
    <input type="hidden" value="{{ isset($_GET['type']) ? $_GET['type'] : \App\Models\Category::TYPE_FAST }}" name="type">
...
<script>
    ...
    layui.use(['form', 'upload', 'iconPickerFa'], function () {
        ...
        form.on('submit(saveBtn)', function (data) {
            postAjaxDestroy('{{ route('admin.category.store') }}', data.field, iframeIndex);
            return false;
        });
    });
</script>
