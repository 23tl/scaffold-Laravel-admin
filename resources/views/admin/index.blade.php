...
<head>
    ...
    <link rel="icon" href="{{ asset('static/admin/images/favicon.ico') }}">
    <link rel="stylesheet" href="{{ asset('static/admin/lib/layui-v2.5.5/css/layui.css') }}" media="all">
    <link rel="stylesheet" href="{{ asset('static/admin/css/layuimini.css?v=2.0.4.2') }}" media="all">
        ...
        <div class="layuimini-header-content">
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item layuimini-setting">
                    <a href="javascript:;">{{ auth()->user()->account }}</a>
...
{{--                        </dd>--}}
                        <dd>
                            <a href="javascript:;" layuimini-content-href="{{ url('admin/account/edit') }}/{{ auth()->id() }}" data-title="修改资料" data-icon="fa fa-gears">修改密码</a>
                        </dd>
                        <dd>
                            <hr>
                        </dd>
