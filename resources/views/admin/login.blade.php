...
<head>
    ...
    <style>
        ...
        .login-main .login-bottom .center .item .icon-1 {background:url('{{ asset('static/admin/images/icon-login.png') }}') no-repeat 1px 0;}
        .login-main .login-bottom .center .item .icon-2 {background:url('{{ asset('static/admin/images/icon-login.png') }}') no-repeat -54px 0;}
        .login-main .login-bottom .center .item .icon-3 {background:url('{{ asset('static/admin/images/icon-login.png') }}') no-repeat -106px 0;}
        .login-main .login-bottom .center .item .icon-4 {background:url({{ asset('static/admin/images/icon-login.png') }}) no-repeat 0 -43px;position:absolute;right:-10px;cursor:pointer;}
        .login-main .login-bottom .center .item .icon-5 {background:url('{{ asset('static/admin/images/icon-login.png') }}') no-repeat -55px -43px;}
        .login-main .login-bottom .center .item .icon-6 {background:url('{{ asset('static/admin/images/icon-login.png') }}') no-repeat 0 -93px;position:absolute;right:-10px;margin-top:8px;cursor:pointer;}
        ...
        .login-main .login-bottom .tip .icon-check {margin:0 7px 0 0;width:14px;height:14px;border:none;background:url('{{ asset('static/admin/images/icon-login.png') }}') no-repeat -111px -48px;}
        ...
        body {background:url('{{ asset('static/admin/images/loginbg.png') }}') 0% 0% / cover no-repeat;position:static;font-size:12px;}
...
<div class="main-body">
    <div class="login-main">
        <div class="login-top">
            <span>{{ config('app.name') }}后台登录</span>
            <span class="bg1"></span>
            <span class="bg2"></span>
        </div>
        <form class="layui-form login-bottom">
            <div class="center">
                ...
                <div id="validatePanel" class="item" style="width: 137px;">
                    ...
                    <img id="refreshCaptcha" class="validateImg" src="{{ captcha_src() }}" onclick="this.src=this.src+'?'+Math.random()">
                </div>
...
<div class="footer">
    ©版权所有 {{ date('Y', time()) }} {{ config('app.name', 'Laravel') }}
</div>
