...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="title" lay-verify="required" lay-reqtext="名称不能为空" placeholder="请输入名称" value="{{ old('title') }}" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="href"  placeholder="请输入链接" value="{{ old('href') }}" class="layui-input">
...
<script>
    ...
    layui.use(['form', 'iconPickerFa'], function () {
         ...
         */
        iconPickerFa.checkIcon('iconPicker', 'fa-circle-o');

        //监听提交
        form.on('submit(saveBtn)', function (data) {
            postAjaxDestroy('{{ route('admin.menus.store') }}', data.field, iframeIndex);
            return false;
        });
